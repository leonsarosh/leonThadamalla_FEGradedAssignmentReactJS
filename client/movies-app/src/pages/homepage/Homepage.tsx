...
const Homepage = () => {
    const [movies, setMovies] = useState<IDataList[]>([]);
    const [favourites, setFavourites] = useState<IDataList[]>([]);
    ...
    const getFavMovies = async (data: any) => {
        setLoading(true);
    ...
    const addFavouriteMovie = async (movie: IDataList) => {
    ...
    const removeFavouriteMovie = async (movie: IDataList) => {
